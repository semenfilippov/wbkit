...
class TestIndex:
    ...
    def test_moment_property(self, idx_value: float, weight: int, c: int, k: int):
    ...
    def test_validate_calc_ops_raises(self, ref_st: float, c: int, k: int):
    ...
    def test_validate_calc_ops_does_not_raise(self):
        a = Index(5, 20, 10, 1, 0)
        b = Index(2, 30, 10, 1, 0)
        a.__validate_calc_ops__(b)

    def test_validate_comp_ops_raises(self):
        a = Index(5, 20, 9, 1, 0)
        b = Index(2, 30, 10, 1, 0)
        with pytest.raises(
            ValueError,
    ...
    def test_validate_comp_ops_does_not_raise(self):
        a = Index(5, 20, 10, 1, 0)
        b = Index(2, 30, 10, 1, 0)
        a.__validate_compare_ops__(b)
    ...
    def test_mul(self, ref_st: float, c: int, k: int):
